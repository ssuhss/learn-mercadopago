...
//require_once LP_PLUGIN_FILE . ' /inc/class-lp-gateway-mercadopago.php';

if ( ! class_exists( 'LP_Gateway_Mercadopago' ) ) {

    class LP_Gateway_Mercadopago extends LP_Gateway_Abstract {
        ...
        public function __construct() {
            ...
            $this->method_title       = __( 'Mercado Pago', 'learnpress' );
            $this->method_description = __( 'Pague com Mercado Pago.', 'learnpress' );
            $this->icon               = '';

            $this->title       = __( 'Mercado Pago', 'learnpress' );
            $this->description = __( 'Pague com Mercado Pago', 'learnpress' );
...
//            $this->paypal_nvp_api_sandbox_url = 'https://api-3t.sandbox.paypal.com/nvp';
            ...
            // get settings
            $this->settings = LP()->settings()->get_group( 'mercadopago', '' );
            $this->enabled = $this->settings->get( 'enable' );

            add_filter('learn_press_payment_method', array($this, 'set_payment_gateway') );
         ...
         * @return array
         */
        public function set_payment_gateway($gateways)
        {
            $mp_gateway = array(
                'Mercado Pago' => 'LP_Gateway_Mercadopago'
            );

            $gateways = array_merge($gateways, $mp_gateway);
...
//            ), 10, 2 );
        ...
        public function get_settings() {
            return apply_filters(
                'learn-press/gateway-payment/mercadopago/settings',
                array(
                    array(
                    ...
                    array(
                        'title'      => __( 'MP Credencial', 'learnpress' ),
                        'id'         => '[paypal_email]',
                        'type'       => 'text',
                        'visibility' => array(
                            'state'       => 'show',
        ...
        public function get_icon() {
            if ( empty( $this->icon ) ) {
                $this->icon = 'https://bipresentes.com.br/wp-content/f15d/uploads/bipresentes.com.br/2019/09/424-4241421_logo-mercado-pago-png-mercadopago-transparent-png.jpg';
                //LP()->plugin_url( 'assets/images/paypal.png' );
            }
